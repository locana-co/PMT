/******************************************************************
Change Script 2.0.6.13 - Consolidated
Performance update...

1. pmt_stat_counts - performance upgrade
2. pmt_stat_project_by_tax - performance upgrade
3. pmt_stat_activity_by_tax - performance upgrade
4. pmt_stat_orgs_by_activity - performance upgrade and adde org name
******************************************************************/
UPDATE config SET changeset = 13, updated_date = current_date WHERE "version" = 2.0 AND iteration = 6;
-- SELECT pmt_version();
-- 
-- SELECT * FROM pmt_stat_counts('', '', '', null, null); -- 80(p) 6112 (a)
-- SELECT * FROM pmt_stat_counts('769', '', '', null, null); -- 72(p) 5656(a)
-- SELECT * FROM pmt_stat_project_by_tax(15, '768', '', '', null, null);-- 80 (this should come up with the same as pmt_stat_counts but there are some duplicate Initiative taxonomy assigments caused by Livestock reassignement from Focus Crop to Initiative
-- SELECT * FROM pmt_stat_activity_by_tax(17, '768', '', '17', null, null); -- 5656
-- SELECT * FROM pmt_stat_orgs_by_activity(1, '768', '', '', null, null); -- compared with pmt1.0.action_partner and got same results
