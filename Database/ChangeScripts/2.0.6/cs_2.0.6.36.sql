/******************************************************************
Change Script 2.0.6.36 - Consolidated.
1. pmt_stat_orgs_by_activity - bug fix. not returning correct counts
for activity counts by classification.
******************************************************************/
INSERT INTO config(version, iteration, changeset) VALUES (2.0, 6, 36);
-- select * from config order by version, iteration, changeset, updated_date;

-- select * from pmt_stat_orgs_by_activity(23, '59,94,107,126,160,186,244,256,768', '', '', null, null)
