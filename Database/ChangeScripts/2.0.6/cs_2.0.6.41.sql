/******************************************************************
Change Script 2.0.6.41 - Consolidated.
1. pmt_filter_csv - new function.
******************************************************************/
INSERT INTO config(version, iteration, changeset) VALUES (2.0, 6, 41);
-- select * from config order by version, iteration, changeset, updated_date;

-- select * from pmt_filter_csv('774','','',null,null, 'warmwters@yahoo.com');

DROP FUNCTION IF EXISTS pmt_filter_cvs(character varying, character varying, character varying, date, date, text); -- (old)
