/******************************************************************
Change Script 2.0.6.40 - Consolidated.
1. pmt_filter_csv - rename to bmgf_filter_csv.
******************************************************************/
INSERT INTO config(version, iteration, changeset) VALUES (2.0, 6, 40);
...
DROP FUNCTION IF EXISTS pmt_filter_cvs(character varying, character varying, character varying, date, date, text);
