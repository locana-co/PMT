/******************************************************************
Change Script 2.0.6.38 - Consolidated.
1. pmt_filter_cvs - add database instance to file name for server
process to use in determining email message content.
******************************************************************/
INSERT INTO config(version, iteration, changeset) VALUES (2.0, 6, 38);
