/******************************************************************
Change Script 2.0.6.24 - Consolidated.
1. pmt_filter_cvs - bug fix. erroring when no data was found, now 
returns false.
******************************************************************/
INSERT INTO config(version, iteration, changeset) VALUES (2.0, 6, 24);

-- SELECT * FROM pmt_filter_cvs('768','','',null,null, 'sparadee@spatialdev.com');
