/******************************************************************
Change Script 3.0.10.64
1. Remove pmt_tax_inuse
2. Create function pmt_classifications to return classifications for
a single taxonomy with usage counts.
******************************************************************/
INSERT INTO version(_version, _iteration, _changeset) VALUES (3.0, 10, 64);
-- select * from version order by _iteration desc, _changeset desc;

/******************************************************************
1. Remove pmt_tax_inuse
******************************************************************/
DROP FUNCTION IF EXISTS pmt_tax_inuse(integer, character varying, character varying);

/******************************************************************
2. Create function pmt_classifications to return classifications for
a single taxonomy with usage counts.
  select * from pmt_classifications(15, '2237', true);
...
******************************************************************/
CREATE OR REPLACE FUNCTION pmt_classifications(taxonomy_id integer, data_group_ids character varying, locations_only boolean) RETURNS SETOF pmt_json_result_type AS
$$
DECLARE
