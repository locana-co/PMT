/******************************************************************
Change Script 2.0.8.28 - consolidated
1. pmt_locations_by_tax - new function, is a overloadded method.
******************************************************************/
INSERT INTO version(version, iteration, changeset) VALUES (2.0, 8, 28);
-- select * from version order by changeset desc;

-- select * from pmt_locations_by_tax(23, '', '');
