/******************************************************************
Change Script 2.0.8.3 - consolidated.
1. pmt_filter_locations - bug fix, was returning g_id when no optional
parameters were passed.
******************************************************************/
INSERT INTO config(version, iteration, changeset) VALUES (2.0, 8, 3);
