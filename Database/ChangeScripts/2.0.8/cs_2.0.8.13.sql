/******************************************************************
Change Script 2.0.8.13 - consolidated.
1. pmt_edit_participation - new function to create/edit participation
of organizations in project/activities
******************************************************************/
INSERT INTO version(version, iteration, changeset) VALUES (2.0, 8, 13);
...
-- select * from pmt_edit_participation(34, null, 463, 1653, 231, 497, 'replace');
-- select * from pmt_edit_participation(34, null, 463, null, 13, 496, 'add');
-- select * from pmt_edit_participation(34, null, 463, null, 27, 496, 'replace');
-- select * from pmt_edit_participation(34, 10708, 463, null, null, null, 'delete');
-- select * from pmt_edit_participation(34, null, 463, null, 27, 496, 'add');
