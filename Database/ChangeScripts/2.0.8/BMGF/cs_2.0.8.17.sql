/******************************************************************
Change Script 2.0.8.17 - consolidated.
1. bmgf_locations_by_tax - adding lat/long fields to return
******************************************************************/
INSERT INTO version(version, iteration, changeset) VALUES (2.0, 8, 17);
-- select * from version order by changeset desc;

-- select * from bmgf_locations_by_tax(23, 768, '55');
-- select * from bmgf_locations_by_tax(23, null, '');

CREATE TYPE bmgf_locations_by_tax_result_type AS (l_id integer, x integer, y integer, lat numeric, lng numeric, r_ids text);

CREATE OR REPLACE FUNCTION bmgf_locations_by_tax(tax_id Integer, data_group Integer, country_ids character varying)
RETURNS SETOF bmgf_locations_by_tax_result_type AS 
$$
DECLARE
