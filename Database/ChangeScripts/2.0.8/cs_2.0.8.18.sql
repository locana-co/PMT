/******************************************************************
Change Script 2.0.8.18 - consolidated.
1. process_xml - bug fix when entering organisation type taxonomy
******************************************************************/
INSERT INTO version(version, iteration, changeset) VALUES (2.0, 8, 18);
-- select * from version order by changeset desc;

-- INSERT INTO xml (action, xml, data_group) VALUES('insert',convert_from(pmt_bytea_import('Bolivia_UNOPS_IATI.xml'), 'utf-8')::xml, 'World Bank');
-- INSERT INTO xml (action, xml, data_group) VALUES('insert',convert_from(pmt_bytea_import('Honduras_UNOPS_IATI.xml'), 'utf-8')::xml, 'World Bank');
-- INSERT INTO xml (action, xml, data_group) VALUES('insert',convert_from(pmt_bytea_import('Kenya_UNOPS_IATI.xml'), 'utf-8')::xml, 'World Bank');
-- INSERT INTO xml (action, xml, data_group) VALUES('insert',convert_from(pmt_bytea_import('Malawi_UNOPS_IATI.xml'), 'utf-8')::xml, 'World Bank');
-- INSERT INTO xml (action, xml, data_group) VALUES('insert',convert_from(pmt_bytea_import('Nepal_UNOPS_IATI.xml'), 'utf-8')::xml, 'World Bank');
