/******************************************************************
Change Script 2.0.8.66
1. pmt_edit_activity_taxonomy - add logic to remove associations to 
an entire taxonomy(ies)
2. pmt_edit_project_taxonomy - add logic to remove associations to 
an entire taxonomy(ies)
******************************************************************/
INSERT INTO version(version, iteration, changeset) VALUES (2.0, 8, 66);
-- select * from version order by changeset desc;

-- Drop old function (Dont remove old function on databases with active applications)
-- DROP FUNCTION IF EXISTS pmt_edit_activity_taxonomy(character varying, character varying, integer, pmt_edit_action)  CASCADE;

-- New Drop Statement for updated function
DROP FUNCTION IF EXISTS pmt_edit_activity_taxonomy(integer, character varying, character varying, character varying, pmt_edit_action)  CASCADE;
...
select * from pmt_edit_activity_taxonomy(57,'10814','788', null,'add') -- pass
select * from pmt_edit_activity_taxonomy(57,'10814','788', null,'delete') -- pass
select * from pmt_edit_activity_taxonomy(57,'10814','788', null,'replace') -- pass
select * from pmt_edit_activity_taxonomy(54,'13264,13355,13361',null, null, 'add') -- pass

-- editor (expected return: true)
select * from pmt_edit_activity_taxonomy(54,'13264,13355,13361','774,1137,1138,778,779', null, 'add') -- pass
select * from pmt_edit_activity_taxonomy(54,'13264,13355,13361','774,1137,1138,778,779','51', 'add') -- pass
select * from pmt_edit_activity_taxonomy(54,'13264,13355,13361',null,'51', null) -- pass
select * from pmt_edit_activity_taxonomy(54,'13264,13355,13361','1137,1138', null,'delete') -- pass
select * from pmt_edit_activity_taxonomy(54,'13355,13361','783',null,'add') -- pass

select * from pmt_edit_activity_taxonomy(54,'13355,13361','784', null, 'replace'); -- original data
select * from pmt_edit_activity_taxonomy(54,'13264','788', null,'replace'); -- original data

-- super (expected return: true)
select * from pmt_edit_activity_taxonomy(55,'10814','788,784',null,'add') -- pass
select * from pmt_edit_activity_taxonomy(55,'10814','788',null,'delete')  -- pass
select * from pmt_edit_activity_taxonomy(55,'10814','849',null,'add') -- pass
select * from pmt_edit_activity_taxonomy(55,'10814','791',null,'replace') -- original data
...
select classification_id, classification, taxonomy, taxonomy_id from taxonomy_classifications where taxonomy  in ('Sub-Initiative','Crops and Livestock') order by taxonomy, classification
...
******************************************************************/   
CREATE OR REPLACE FUNCTION pmt_edit_activity_taxonomy(user_id integer, activity_ids character varying, classification_id character varying, remove_taxonomy_ids character varying, edit_action pmt_edit_action) RETURNS BOOLEAN AS 
$$
DECLARE
...
BEGIN	
      ...
      FOREACH t_id IN ARRAY valid_taxonomy_ids LOOP 
        FOREACH a_id IN ARRAY valid_activity_ids LOOP 
          ...
          IF (SELECT * FROM pmt_validate_user_authority($1, p_id, 'update')) AND (SELECT * FROM pmt_validate_user_authority($1, p_id, 'create')) THEN
            -- remove all classifications for given taxonomy 
            EXECUTE 'DELETE FROM activity_taxonomy WHERE activity_id ='|| a_id ||' AND classification_id in ' ||
                    '(SELECT classification_id FROM taxonomy_classifications WHERE taxonomy_id = '|| t_id ||') AND field = ''activity_id''';
            RAISE NOTICE 'Delete Record: %', 'Remove association to taxonomy_id ('|| t_id ||') for actvity_id ('|| a_id ||')';           
           ELSE
              RAISE NOTICE 'Error: The requested edit action requires the user to have UPDATE and CREATE rights to this project: %', p_id;
              RETURN FALSE;
           END IF;  
  ...
  ELSE
   RAISE NOTICE 'Error: Must provide user_id, activity_ids AND either classification_ids or remove_taxonomy_id parameters.';
    RETURN false;
  END IF; 	
...
-- reader (expected return: false) 
select * from pmt_edit_project_taxonomy(57,'463,664,663','824',null,'add') -- pass
select * from pmt_edit_project_taxonomy(57,'463,664,663','824',null,'delete') -- pass
select * from pmt_edit_project_taxonomy(57,'463,664,663','852',null,'replace') -- pass

-- editor (expected return: true)
select * from pmt_edit_project_taxonomy(54,'662,665,661,463','829,831,819,820',null,'add') -- pass
select * from pmt_edit_project_taxonomy(54,'662,665,661','819,'820',null,'delete') -- pass
select * from pmt_edit_project_taxonomy(54,'662,665,661,463','829',null,'delete') -- pass
select * from pmt_edit_project_taxonomy(54,'662,665,661,463','831',null,'add') -- pass
select * from pmt_edit_project_taxonomy(54,'662,665,661,463','831',null,'delete') -- pass

-- super (expected return: true)
select * from pmt_edit_project_taxonomy(55,'662,665,661,463','829,831,819,820',null,'add') -- pass
select * from pmt_edit_project_taxonomy(55,'662,665,661,463',null,'22',null) -- pass
select * from pmt_edit_project_taxonomy(55,'662,665,661','819,820',null,'delete') -- pass
select * from pmt_edit_project_taxonomy(55,'662,665,661,463','829',null,'delete') -- pass
select * from pmt_edit_project_taxonomy(55,'662,665,661,463','831',null,'add') -- pass
select * from pmt_edit_project_taxonomy(55,'662,665,661,463',831,null,'delete') -- pass

select * from pmt_edit_project_taxonomy(55,'665,463','831',null,'replace'); -- original data
select * from pmt_edit_project_taxonomy(55,'662','825',null,'replace'); -- original data
select * from pmt_edit_project_taxonomy(55,'661','824',null,'replace'); -- original data
select * from pmt_edit_project_taxonomy(55,'463','816,820,819,821,854',null,'replace'); -- original data

select * from pmt_edit_project_taxonomy(null,'662,665,661,463','831',null,'delete') -- pass (false)
select * from pmt_edit_project_taxonomy(55,null,'831',null,'delete') -- pass (false)
select * from pmt_edit_project_taxonomy(55,'662,665,661,463',null,null) -- pass (false)
select * from pmt_edit_project_taxonomy(55,'662,665,661,463','9999',null,'add') -- pass (false)

select pt.project_id, pt.classification_id, tc.taxonomy, tc.taxonomy_id, tc.classification 
...
-- New Drop Statement for updated function
DROP FUNCTION IF EXISTS pmt_edit_project_taxonomy(integer,character varying, character varying, character varying, pmt_edit_action)  CASCADE;

/******************************************************************
   pmt_edit_project_taxonomy
******************************************************************/
CREATE OR REPLACE FUNCTION pmt_edit_project_taxonomy(user_id integer, project_ids character varying, classification_ids character varying, remove_taxonomy_ids character varying, edit_action pmt_edit_action) RETURNS BOOLEAN AS 
$$
DECLARE
  valid_classification_ids integer[];	-- valid classification_ids from parameter
...
BEGIN	
      ...
      FOREACH t_id IN ARRAY valid_taxonomy_ids LOOP 
        FOREACH p_id IN ARRAY valid_project_ids LOOP
          ...
          IF (SELECT * FROM pmt_validate_user_authority($1, p_id, 'update')) AND (SELECT * FROM pmt_validate_user_authority($1, p_id, 'create')) THEN
            -- remove all classifications for given taxonomy 
            EXECUTE 'DELETE FROM project_taxonomy WHERE project_id ='|| p_id ||' AND classification_id in ' ||
		      '(SELECT classification_id FROM taxonomy_classifications WHERE taxonomy_id = '|| t_id||') AND field = ''project_id''';
            RAISE NOTICE 'Delete Record: %', 'Remove association to taxonomy_id ('|| t_id ||') for project_id ('|| p_id ||')';
           ELSE
              RAISE NOTICE 'Error: The requested edit action requires the user to have UPDATE and CREATE rights to this project: %', p_id;
              RETURN FALSE;
           END IF;  
  ...
  -- first three parameters are required 
  ELSE
   RAISE NOTICE 'Error: Must provide user_id, project_ids AND either classification_ids or remove_taxonomy_id parameters.';
    RETURN false;
  END IF; 
