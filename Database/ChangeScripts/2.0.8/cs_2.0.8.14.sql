/******************************************************************
Change Script 2.0.8.14 - consolidated.
1. process_xml - bug fix that trims incoming organization names to 
ensure they do not exceed our 255 character limitation.
******************************************************************/
INSERT INTO version(version, iteration, changeset) VALUES (2.0, 8, 14);
