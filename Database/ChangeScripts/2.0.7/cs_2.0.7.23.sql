/******************************************************************
Change Script 2.0.7.23 - Consolidated.
1. pmt_activity_listview - rewrite of the function. 
******************************************************************/
INSERT INTO config(version, iteration, changeset) VALUES (2.0, 7, 23);
-- select * from config order by changeset desc;

-- select * from  pmt_activity_listview('769', '', '15', null,null, '15,5', 'a_id', 10, null); 
-- select * from  pmt_activity_listview('769', '', '15', null,null, '15,5', 'tax2', 10, null); 
-- select * from  pmt_activity_listview('769', '', '23', null,null, '23', 'a_id', 10, null); 
-- select * from  pmt_activity_listview('769', '', '', '1-1-1990','12-31-2014', '23', 'a_id', 10, 100);
-- select * from  pmt_activity_listview('769', '', '15', '1-1-1990','12-31-2014', '15', 'a_name', 10, 100);

-- CREATE INDEX activity_title_idx on activity(title);  -- Analyze
