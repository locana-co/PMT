/******************************************************************
Change Script 2.0.7.13 - Consolidated.
1. pmt_stat_orgs_by_activity - bug fix calling organization_ids in where
which does not exsist on organization_lookup.
******************************************************************/
INSERT INTO config(version, iteration, changeset) VALUES (2.0, 7, 13);
-- select * from config order by version, iteration, changeset, updated_date;

--select * from pmt_stat_orgs_by_activity(23, '59,94,107,126,160,186,244,256,769', '364', '', null, null)
