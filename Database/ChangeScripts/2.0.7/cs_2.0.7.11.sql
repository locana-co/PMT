/******************************************************************
Change Script 2.0.7.11 - Consolidated.
1. pmt_activity_listview - bug fix with organization filter.
******************************************************************/
INSERT INTO config(version, iteration, changeset) VALUES (2.0, 7, 11);
-- select * from config order by version, iteration, changeset, updated_date;

-- select * from  pmt_activity_listview(15, '769,496,815,819', '27,231', null, null, null, null);
