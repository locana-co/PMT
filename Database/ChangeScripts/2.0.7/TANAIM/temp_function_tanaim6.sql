-- select * from temp_stat_orgs_by_activity(17, '59,94,107,126,160,186,244,256,768,769', '', '', null, null)

CREATE TYPE temp_stat_orgs_by_activity_result AS (response json);

CREATE OR REPLACE FUNCTION temp_stat_orgs_by_activity(tax_id integer, classification_ids character varying, organization_ids character varying, unassigned_tax_ids character varying, 
