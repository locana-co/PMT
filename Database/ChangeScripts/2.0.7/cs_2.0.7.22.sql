/******************************************************************
Change Script 2.0.7.22 - Consolidated.
1. taxonomy_classifications - converting from view to materialized
view with indexes.
******************************************************************/
INSERT INTO config(version, iteration, changeset) VALUES (2.0, 7, 22);
