...
--Drop Functions
DROP FUNCTION IF EXISTS bmgf_global_search(text)  CASCADE;
...
DROP FUNCTION IF EXISTS bmgf_filter_csv(character varying, character varying, character varying, date, date) CASCADE;
DROP FUNCTION IF EXISTS pmt_project_list() CASCADE;

--Drop Types  (if it exists)
--DROP TYPE IF EXISTS pmt_infobox_result_type;
DROP TYPE IF EXISTS bmgf_global_search_result_type;
...
Create FUNCTIONS:
	...
	10. bmgf_filter_csv - exports data to cvs based using the 
...
-- export to cvs 
CREATE OR REPLACE FUNCTION bmgf_filter_csv(classification_ids character varying, organization_ids character varying, unassigned_tax_ids character varying, start_date date, end_date date, email text) 
    RETURNS BOOLEAN AS $$
DECLARE
  project_ids int[];	
  activity_ids int[];
...
AS SELECT 'activity table' as "table", COUNT(*)::integer AS "current record count", 6986 AS "correct record count", 'Populated by LoadBMGFData.sql & ScrubBMGFData.sql' as "comments" FROM activity
UNION ALL
...
UNION ALL
SELECT 'activity_taxonomy junction table' as "table", COUNT(*)::integer AS "current record count", 10076 AS "correct record count", 'Populated by LoadBMGFData.sql & ScrubBMGFData.sql' as "comments" FROM activity_taxonomy
UNION ALL
...
UNION ALL
SELECT 'financial table' as "table", COUNT(*) AS "current record count", 1291 AS "correct record count", 'Populated by LoadBMGFData.sql & ScrubBMGFData.sql' as "comments" FROM financial			
UNION ALL
...
UNION ALL
SELECT 'location table' as "table", COUNT(*) AS "current record count", 8061 AS "correct record count", 'Populated by LoadBMGFData.sql & ScrubBMGFData.sql' as "comments" FROM location 
UNION ALL
SELECT 'location_boundary junction table' as "table", COUNT(*) AS "current record count", 24303 AS "correct record count", 'Populated by CreatePMTSpatialData(n).sql' as "comments" FROM location_boundary
UNION ALL
SELECT 'location_taxonomy junction table' as "table", COUNT(*) AS "current record count", 8021 AS "correct record count", 'Populated by LoadBMGFData.sql.' as "comments" FROM location_taxonomy
UNION ALL
SELECT 'organization table' as "table", COUNT(*) AS "current record count", 1198 AS "correct record count", 'Populated by LoadBMGFData.sql & ScrubBMGFData.sql' as "comments" FROM organization		
UNION ALL
...
UNION ALL
SELECT 'participation table' as "table", COUNT(*) AS "current record count", 6563 AS "correct record count", 'Populated by LoadBMGFData.sql & ScrubBMGFData.sql' as "comments" FROM participation
UNION ALL
SELECT 'participation_taxonomy junction table' as "table", COUNT(*) AS "current record count", 6614 AS "correct record count", 'Populated by LoadBMGFData.sql & ScrubBMGFData.sql' as "comments" FROM participation_taxonomy
UNION ALL
SELECT 'project table' as "table", COUNT(*) AS "current record count", 374 AS "correct record count", 'Populated by LoadBMGFData.sql & ScrubBMGFData.sql' as "comments" FROM project			
UNION ALL
...
UNION ALL
SELECT 'project_taxonomy junction table' as "table", COUNT(*) AS "current record count", 1079 AS "correct record count", 'Populated by LoadBMGFData.sql, ScrubBMGFData.sql & LoadBMGFNutritionData.sql.' as "comments" FROM project_taxonomy
UNION ALL
...
UNION ALL
SELECT 'classification table' as "table", COUNT(*) AS "current record count", 855 AS "correct record count", 'Populated by LoadBMGFData.sql, ScrubBMGFData.sql, LoadBMGFNutritionData.sql & LoadIATIStandards.sql.' as "comments" FROM classification
UNION ALL
