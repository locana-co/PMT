...
(
	"id"			SERIAL 				NOT NULL
	,"_name"		character varying(250)
	,"_description" 	character varying
	,"_spatial_table"	character varying(50)
	,"_version" 		character varying(50)
	,"_source"	 	character varying(150)
	,"_active"		boolean				NOT NULL DEFAULT TRUE
	,"_retired_by"		integer
	,"_created_by" 		character varying(150)
	,"_created_date" 	timestamp without time zone 	NOT NULL DEFAULT current_date
	,"_updated_by" 		character varying(150)
	,"_updated_date" 	timestamp without time zone 	NOT NULL DEFAULT current_date	
	,CONSTRAINT pk_boundary_id PRIMARY KEY(id)	
);
-- Configuration
CREATE TABLE "config" 
(
	"id" 			SERIAL				NOT NULL
	,"_version"		numeric(2,1)
	,"_download_dir"	text
	,"_created_date" 	timestamp without time zone 	NOT NULL DEFAULT current_date
	,"_updated_date" 	timestamp without time zone 	NOT NULL DEFAULT current_date
...
INSERT INTO config(_version, _download_dir) VALUES (3.0, '/var/lib/postgresql/9.3/main/');
-- Contact
...
(
	...
	,"_first_name" 		character varying(64)
...
INSERT INTO version(version, iteration, changeset) VALUES (3.0, 0, 0);
-- XML
CREATE TABLE "xml"
(
